      ...
      <div className="container mx-auto max-w-xl p-6 bg-gray-800 rounded-lg shadow-lg">
        ...
        <div className="mt-6 text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a href="https://github.com/MYousuf-codes" target="_blank"  
            className="hover:bg-blue-900 transition duration-300 ease-in-out transform hover:scale-105"  
            rel="noopener noreferrer">
              <Image src="/github.png" alt="GitHub" width={30} height={30} />
            </a>

            <a href="https://linkedin.com/in/MYousuf-codes" target="_blank" 
            className="hover:bg-blue-900 transition duration-300 ease-in-out transform hover:scale-105" 
            rel="noopener noreferrer">
              <Image src="/linkedin.png" alt="LinkedIn" width={30} height={30} />
            </a>

            <a href="https://facebook.com/muhammadyousafmarfaniMYM" target="_blank" 
            className="hover:bg-blue-900 transition duration-300 ease-in-out transform hover:scale-105" 
            rel="noopener noreferrer">
              <Image src="/facebook.png" alt="Facebook" width={30} height={30} />
            </a>

            <a href="https://instagram.com/m_yousuf575" target="_blank" 
            className="hover:bg-blue-900 transition duration-300 ease-in-out transform hover:scale-105" 
            rel="noopener noreferrer">
